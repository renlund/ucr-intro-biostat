...
mutually exclusive events the \[ \pr(A \el B)=\pr(A)+\pr(B). \] (Probability is a "measure". \\ But what does it measure?) \\
\end{itemize}
...
Value $k$ & 1  & 2 & 3 & 4 & 5 & 6 \\
$\pr(X=k)$ & 1/6 & 1/6 & 1/6 & 1/6 & 1/6 & 1/6\\ \hline
\end{tabular}\end{center}
