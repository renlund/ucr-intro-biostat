...
%% \frame{ % -------------------------------------------------------------------->
%%   \frametitle{Some rules of thumb for tables (for publication)}
%% \begin{itemize}
%%    \item Table and caption should be self contained.
%%    \item Put captions \emph{above} the table.
%%    \item Avoid excessive precision, e.g.\ probably not clinically meaningful to
%%      specify a mean age of 65.637 rather than 65.6.
%%    \item Use adequate measures of location and spread. (We will talk more about this.)
%%    \item Refer to each table included and perhaps guide to reader as to what the table
%% illustrates in relation to the narrative of the article.
%% \end{itemize}
%% }
\frame{ %-------------------------------------------------------------------->
...
%% }
%% \frame{ % -------------------------------------------------------------------->
%% \frametitle{Some rules of thumb for graphs (for publication)}
%% \begin{itemize}
...
%%       \begin{itemize}
%%          \item a cumulative frequency gives a lot of detail of a data set. \\
%%          \item graph with multiple boxplots can reveal patterns among subgroups.
%%       \end{itemize}
