...
barchart(a_table, col = wes.palette(5, "Cavalcanti"))
pie(a_table, col = wes.palette(5, "Cavalcanti"))
...
<<exp_mean>>=
COL <- wes.palette(5, "Cavalcanti") #brewer.pal(5, "Set2")
par(mar=c(4,4,1,1))
...
par(mar=c(4,4,0,0))
hist(y-x, freq=FALSE, breaks=seq(-50,150,len=10), xlab="Differences (formoterol-sabutamol) L/min", xlim=c(-60,160), ylim=c(0,.018), main="", col=.blue)
