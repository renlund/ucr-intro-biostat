...
% \begin{center}
% \begin{figure}
% \includegraphics[scale=0.45]{pics/Karl_Pearson_2.jpg}
% \caption{Karl Pearson introduced the $\chi^2$-test in ''On the Criterion that a Given System of Deviations from the Probable in the Case of a Correlated System of Variables is such that it can be Reasonably Supposed to have Arisen from Random Sampling'' (1900) }
% \end{figure}
% \end{center}
% }
\frame{ % -------------------------------------------------------------------->
\begin{center}
\includegraphics[scale=0.5]{pics/Betting-Odds.jpg}
\end{center}
}
\frame{ % -------------------------------------------------------------------->
\titlepage
...
@
\begin{center} \includegraphics[scale=0.4]{figure/OR} \end{center}
}
\frame{ % -------------------------------------------------------------------->
...
text(17, dhyper(17,347, 371, 35), pos=3, label="Expected", offset=1, cex=1.5)
...
text(x=22, y=dhyper(17,347, 371, 35), pos=3, label="Discrepancy")
...
uncertainty of $p_2$.
% Of course there are reasons to be interested in e.g.\
% the absolute risk
% as well as the risk difference.
}
\frame{ % -------------------------------------------------------------------->
